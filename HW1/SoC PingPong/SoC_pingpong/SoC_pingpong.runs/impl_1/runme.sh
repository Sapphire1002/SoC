...
HD_PWD='H:/SoC/SoC_HW 2017/SoC_pingpong/SoC_pingpong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_pingpong_v3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SoC_pingpong_v3.tcl -notrace
