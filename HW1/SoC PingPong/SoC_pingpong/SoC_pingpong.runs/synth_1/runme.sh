...
HD_PWD='H:/SoC/SoC_HW 2017/SoC_pingpong/SoC_pingpong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_pingpong_v3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_pingpong_v3.tcl
